#99 bottles of beer on the wall - python exercise

for number_bottles in range(99,1,-1):
	print "{0} bottles of beer on the wall, {1} bottles of beer ...".format(number_bottles, number_bottles)
	print "If one of those bottles should happen to fall, {0} bottles of beer on the wall".format(number_bottles - 1)
